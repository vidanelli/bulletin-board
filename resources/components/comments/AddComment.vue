                ...
                <div class="uk-flex comment-stars">
                    <div @mouseenter="cancel = true" @mouseleave="cancel = false">
                        <a @click="formData.commentData.rating = 0;">
                            <img v-if="!cancel" src="/resources/assets/images/cancel-off.svg" class="rating-cancel">
                            <img v-else src="/resources/assets/images/cancel-on.svg" class="rating-cancel">
                        </a>
                    </div>
